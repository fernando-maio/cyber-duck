        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form role="form" method="POST" action="{{ route('companies.update', array($company->id)) }}" enctype="multipart/form-data">
                        @method('PATCH ')
                        @csrf
                        <!-- Name -->
                        <div>
                        ...
                        @if(!empty($company->logo))
                            <div class="mt-4">
                                <img class="w-40 mb-1" src="{{ asset('storage/' . $company->logo) }}" alt="{{ $company->name }}">
                            </div>
                        @endif
                        <div class="mt-4">
